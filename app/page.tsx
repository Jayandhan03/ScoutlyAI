      ...
      <section id="features" className="features-section">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <h2 style={{
            ...
            fontWeight: 800, letterSpacing: "-0.035em", margin: 0,
            lineHeight: 1.15
        ...
        <div className="features-grid">
          <FeaturePill
            ...
            desc="Select your favorite topics, trusted sources and use AI to tailor a news feed that matches your morning routine perfectly."
            accent="#6c8fff"
          />
          <FeaturePill
            icon="⚡"
            title="Instant Delivery"
            desc="No delays. Our AI processes and generates your audio briefing in real-time, delivered the moment it's ready."
            accent="#a78bfa"
          />
          <FeaturePill
            icon="💬"
            title="Native Chat Experience"
            desc="No new apps. Works natively in WhatsApp or Telegram with interactive voice chat controls right in your thread."
            accent="#38bdf8"
          />
          <FeaturePill
            icon="🧠"
            title="Adaptive Intelligence"
            desc="The more you listen, the smarter your briefing becomes. Our AI learns your preferences and optimizes your feed."
            accent="#34d399"
          />
          <FeaturePill
            icon="🌍"
            title="20+ Languages"
            desc="Receive your briefings in any of 20+ supported languages with ultra-realistic neural text-to-speech voices."
            accent="#f472b6"
          />
          <FeaturePill
            icon="📊"
            title="Source Analytics"
            desc="Full transparency on your news sources. Track reliability scores, publication history, and bias ratings."
            accent="#fb923c"
          />
        </div>
      </section>
            ...
            <div className="mock-body">
              <div className="mock-bubble">
                <div className="mock-bubble-title">
                  🌅 Good morning! Here is your personalized briefing for today, Sunday April 13
                </div>
              </div>
